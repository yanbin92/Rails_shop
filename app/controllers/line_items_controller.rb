class LineItemsController < ApplicationController 
 ...
 # include CurrentCart
  ...
  def create
    ...
    @line_item = @cart.add_product(product)#line_items.build(product: product) #LineItem.new(line_item_params)
    session[:counter] = 0
  ...
  private
    ...
    def line_item_params
      params.require(:line_item).permit(:product_id)# params.require(:line_item).permit(:product_id, :cart_id
    end
end
